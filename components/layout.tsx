...
import NavButton from "./bottom-nav-button";
    ...
    <div>
      ...
      <nav className="w-full max-w-lg border-t-2 text-gray-600 bg-white fixed bottom-0 pb-4 pt-3  flex justify-around items-center">
        ...
        <NavButton
          ...
          route="/community"
          onPage={router.pathname == "/community"}
        />
        <NavButton
          title="채팅"
          d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"
          route="/chats"
          onPage={router.pathname == "/chats"}
        />
        <NavButton
          title="라이브"
          d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"
          route="/stream"
          onPage={router.pathname == "/stream"}
        />
        <NavButton
          title="나의 캐럿"
          d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"
          route="/profile"
          onPage={router.pathname == "/profile"}
        />
      </nav>
    </div>
  );
