    ...
    <Layout isIndex={true} title="나의 캐럿">
      <div className="py-6 px-4">
        ...
        <div className="w-full flex justify-around mt-10">
          ...
          <div className=" flex flex-col items-center cursor-pointer group">
            <div className="w-14 h-14 flex items-center justify-center text-white rounded-full bg-orange-400 group-hover:bg-orange-500">
              <svg
                className="w-6 h-6"
                fill="none"
                stroke="currentColor"
        ...
        <div className="mt-12">
          <div className="flex space-x-3 items-center">
            ...
            <div>
              <h4 className="font-medium text-sm text-gray-700">니꼬</h4>
